...
modified: "2025-11-07"
category: "기술"
tags: ["JavaScript", "async", "await", "Promise", "비동기처리"]
excerpt: "async/await를 반복문에서 쓰면 뭔가 느리다고 느낀 적 있나요? 순차 실행과 병렬 실행의 차이, 그리고 안전하게 처리하는 방법을 알아봅니다."
---
...
| 목적                   | 패턴                    | 동시 실행 수 |
| ---------------------- | ----------------------- | ------------ |
| 순서 유지, 하나씩 실행 | `for...of + await`      | 1            |
| 빠르게 전부 실행       | `Promise.all() + map()` | 무제한       |
| 실행 수 제한           | `p-limit` 등            | N개 (커스텀) |
