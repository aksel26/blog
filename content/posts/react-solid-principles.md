---
title: "React에서 SOLID 원칙 적용하기: 더 나은 컴포넌트 설계를 위한 실전 가이드"
date: "2025-11-04"
modified: "2025-11-04"
category: "기술"
tags: ["React", "SOLID", "디자인 패턴", "컴포넌트 설계", "클린 코드", "프론트엔드"]
excerpt: "객체지향의 5대 원칙 SOLID를 React 컴포넌트에 적용하는 방법을 실제 코드 예시와 함께 알아봅니다."
---
...
데이터 불러오기 로직을 커스텀 훅으로 분리함으로써 각 부분이 하나의 책임만 갖게 되었습니다. `useUser` 훅은 다른 컴포넌트에서도 재사용할 수 있고, `UserProfile`은 UI 렌더링에만 집중할 수 있습니다.
...
function Form({ InputComponent }) {
  ...
  return <InputComponent value={...} onChange={...} />;
}
```
