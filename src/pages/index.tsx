  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <section
          className="text-left py-16 mb-16 rounded-lg"
          // style={{
...
export const Head = () => (
  <>
    ...
    <meta
      name="description"
      content="개발 과정에서 배운 것들과 일상의 소중한 순간들을 나누는 개인 블로그입니다."
    />
    <meta
    ...
    <meta
      ...
      content="b8551eee139d8570cac6b62587127de0de5c7d9d"
    />
