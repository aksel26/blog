  ...
  return (
    <Layout>
      ...
      <div className="max-w-4xl mx-auto text-center py-16">
        <div className="mb-8">
          <img src="/404.webp" alt="404" className="w-32 h-32 flex items-center justify-center mx-auto mb-6" />
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: "var(--text-secondary)" }}>
            요청하신 페이지가 존재하지 않거나 이동되었을 수 있습니다. 아래 링크를 통해 다른 페이지로 이동해보세요.
          </p>
        </div>
          ...
          <Link to="/" style={{ textDecoration: "none" }}>
            ...
            >
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full flex items-center justify-center mr-3" style={{ backgroundColor: "var(--accent-blue-light)" }}>
